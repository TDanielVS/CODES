...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_Topspeed = 41.857f;
        [SerializeField] private static int NoOfGears = 5;
        [SerializeField] private float m_RevRangeBoundary = 1f;
        [SerializeField] private float m_SlipLimit;
        [SerializeField] private float m_BrakeTorque;

        public const string CSVFileName = "datosBolsa.csv";
        public const string DirFrames = "imagenesBolsa";
        ...
        private void Start ()
        {
            ...
            seterCar = GameObject.Find("persistent");
            seterCar.SendMessage("SetCarPos");
		...
		public IEnumerator WriteSamplesToDisk()
		{
			...
			if (carSamples.Count > 0) {
                ...
                string[] cads = centerPath.Split(Path.DirectorySeparatorChar);
                centerPath = cads[cads.Length - 1];
                ...
                string row = string.Format("{0},{1},{2},{3},{4}\n", centerPath, sample.throttle, sample.steeringAngle, sample.brake, sample.speed);
        ...
        private void OpenFolder(string location)
        {
            ...
            if (Directory.Exists(m_saveLocation))
            {
                ...
                Directory.Delete(m_saveLocation, true);
            }
